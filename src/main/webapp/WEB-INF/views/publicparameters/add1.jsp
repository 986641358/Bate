...
<body>
<blockquote class="layui-elem-quote layui-text" style="margin: 15px 0 15px 15px;">管理 </blockquote>
...
<fieldset class="layui-elem-field" style="margin-top: 2%">
	...
	<div class="layui-field-box">
		<form class="layui-form layui-form-pane" action="">
			...
			<div class="layui-form-item">
				<label class="layui-form-label"><span style="color:red;">*</span>method</label>
					<div class="layui-input-block">
						<input type="text" name="method" id="method" lay-verify="required" placeholder="请输入命令方法 " autocomplete="off" class="layui-input" style="width:400px">
					</div>
			</div>
			<div class="layui-form-item">
